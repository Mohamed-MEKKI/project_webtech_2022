...
<div className="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea name='content' rows="8" className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Tell us what you think..." required></textarea>
       </div>
